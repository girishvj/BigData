...
public class TransactionPOJO implements Serializable {
	...
	/* The class TransactionPOJO is an implementation of a serializable POJO (Plain Old Java Object). 
	 * Each object of the class TransactionPOJO stores a Transaction record for a particular transaction received from Kafka Server.
